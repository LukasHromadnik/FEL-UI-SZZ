...
* $f(n) \in \Theta(g(n))$  
    The value of the function $f$ is equal the value of the function $g$ within a constant factor
...
**Directed Acyclic Graph (DAG).** DAG is a directed graph without cycles.
